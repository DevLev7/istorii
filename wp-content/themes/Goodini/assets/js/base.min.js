 ...
 */
"use strict";function findVideos(){for(var e=document.querySelectorAll(".video"),t=0;t<e.length;t++)setupVideo(e[t])}function setupVideo(t){var r=t.querySelector(".video__link"),o=(t.querySelector(".video__media"),t.querySelector(".video__button")),i=r.id;t.addEventListener("click",function(){var e=createIframe(i);r.parentNode.removeChild(r),o.parentNode.removeChild(o),t.appendChild(e)}),r.removeAttribute("href"),t.classList.add("video--enabled")}function createIframe(e){var t=document.createElement("iframe");return t.setAttribute("allowfullscreen",""),t.setAttribute("allow","autoplay"),t.setAttribute("src",generateURL(e)),t.classList.add("video__media"),t}function generateURL(e){return"https://www.youtube.com/embed/"+e+"?rel=0&showinfo=0&autoplay=1"}findVideos();
...
/*
Горизонтальный скролл буллитов
*/
!function(m){m.fn.EhoopScrollBar=function(r){var b=m.extend({runnerWidth:50,runnerHeight:6,paddingBottom:6,backgroundScroll:"rgba(0,0,0,0.3)",backgroundRunner:"#000",minWidthItem:0},r);null!=r?this.each(function(){var r,n,e,s,i,o,l=b.runnerWidth,t=b.runnerHeight,a=b.paddingBottom,c=b.backgroundScroll,d=b.backgroundRunner,h=b.minWidthItem,p=m(this),g=0,f=p.outerWidth(),u=0;p.wrapAll('<div class="wrapper-ehoopscrollbar"></div>'),(r=p.parent()).css("position","relative"),p.css({"overflow-x":"scroll","overflow-y":"hidden",display:"flex","flex-direction":"row","flex-wrap":"nowrap",position:"relative",padding:"0px 0px "+a+"px 0px"}).addClass("ehoopScrollBar"),e=p.children("div").length,0<h&&p.children("div").css("min-width",h);for(var v=0;v<e;v++)v==e-1&&p.children("div:eq("+v+")").css("margin-right",0),g+=p.children("*:eq("+v+")").width()+parseInt(p.children("*:eq("+v+")").css("margin-left"))+parseInt(p.children("*:eq("+v+")").css("margin-right"))+parseInt(p.children("*:eq("+v+")").css("padding-left"))+parseInt(p.children("*:eq("+v+")").css("padding-right"));r.append('<div class="ehoopscrollbar"><span></span></div>'),r=r.children(".ehoopscrollbar"),m(r).css({position:"absolute",left:0,right:0,bottom:0,height:t+"px",width:f+"px",background:c,overflow:"hidden",border:"none",margin:0}),n=r.children("span"),m(n).css({position:"absolute",left:"0%","top:":0,width:l+"px",height:t+"px",background:d}),i=(u=g-f)/100,p.scroll(function(){(s=m(this).scrollLeft())<u+3&&0<s&&p.children(".ehoopscrollbar").css({transform:"translateX("+s+"px)"}),o=parseInt(s/i),n.css("transform","translateX("+(f/100*o-l*o/100)+"px)")})}):this.each(function(){var r,n,e,s,i,o,l=m(this),t=0,a=l.outerWidth(),c=0;l.wrapAll('<div class="wrapper-ehoopscrollbar"></div>'),r=l.parent(),l.addClass("inner-ehoopscrollbar"),e=l.children("*").length;for(var d=0;d<e;d++)t+=l.children("*:eq("+d+")").width()+parseInt(l.children("*:eq("+d+")").css("margin-left"))+parseInt(l.children("*:eq("+d+")").css("margin-right"))+parseInt(l.children("*:eq("+d+")").css("padding-left"))+parseInt(l.children("*:eq("+d+")").css("padding-right"));r.append('<div class="ehoopscrollbar"><span></span></div>'),r=r.children(".ehoopscrollbar"),n=r.children("span"),i=(c=t-a)/100,l.scroll(function(){(s=m(this).scrollLeft())<c+3&&0<s&&l.children(".ehoopscrollbar").css({transform:"translateX("+s+"px)"}),o=parseInt(s/i),console.log("scrollLeft("+s+") / oneProcent("+i+") = actionProcent("+o+")"),n.css("transform","translateX("+(a/100*o-m(n).outerWidth()*o/100)+"px)")})})}}(jQuery);


// инициализация
//$('.Ehoop').EhoopScrollBar();
...
$(".bullets-slider .bul-gallery-slider").brazzersCarousel();
...
//==============
	...
	if(body_width < 768){
		$('.Ehoop-sm').EhoopScrollBar();
	}
	if(body_width < 500){
		$('.Ehoop-xs').EhoopScrollBar();
	}
	
//Форма
//==============
	var oldfunc;$("form").validate({hideLabels:!0}),$.fancybox&&(oldfunc=$.fancybox.defaults.clickContent,$.fancybox.defaults.clickContent=function(l,e){l.$content[0].contains(document.activeElement)&&document.activeElement.blur(),oldfunc(l,e)});var $label=$("label[for=attachment] span"),labelOrig=$label.html();$("#attachment").change(function(){for(var l=[],e=0;e<this.files.length;e++)l.push(this.files[e].name);l.length?$label.html(l.join("; ")):$label.html(labelOrig)});
...
//==============
	$(".ancor").on("click","a",function(t){t.preventDefault();var o=$(this).attr("href"),a=$(o).offset().top;$("body,html").animate({scrollTop:a},500)});
...
// Команда
	$("#team .slider").slick({lazyLoad:"ondemand",slidesToShow:4,slidesToScroll:1,dots:!1,focusOnSelect:!0,infinite:!0,adaptiveHeight:!1,appendArrows:$(".team-arrow"),prevArrow:'<button id="prev" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path  d="M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z" /></svg></button>',nextArrow:'<button id="next" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" /></svg></button>',responsive:[{breakpoint:1150,settings:{slidesToShow:3}},{breakpoint:1024,settings:{slidesToShow:2}},{breakpoint:500,settings:{slidesToShow:1}}]});

// Акции
	$("#modules .actions-section .slider").slick({slidesToShow:1,slidesToScroll:1,adaptiveHeight:1,dots:!0,fade:!0,appendArrows:$(".actions-slider-arrow"),prevArrow:'<button id="prev" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path  d="M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z" /></svg></button>',nextArrow:'<button id="next" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" /></svg></button>',/*dotsClass:"cases-paging actions-paging-item",customPaging:function(s,a){return a+1+"<span>/"+s.slideCount+"</span>"}*/});

// Кейсы
	$("#modules .cases .slider").slick({slidesToShow:1,slidesToScroll:1,adaptiveHeight:1,dots:!0,fade:!0,appendArrows:$(".cases-arrow"),prevArrow:'<button id="prev" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path  d="M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z" /></svg></button>',nextArrow:'<button id="next" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" /></svg></button>',dotsClass:"cases-paging cases-paging-item",customPaging:function(s,a){return a+1+"<span>/"+s.slideCount+"</span>"}});

// Кейсы галерея	
	$("#modules .cases .case-gallery-slider").slick({slidesToShow:1,slidesToScroll:1,dots:!0,fade:!0,dotsClass:"cases-paging cases-paging-gallery",customPaging:function(s,a){return a+1+"<span>/"+s.slideCount+"</span>"}});

// Видеоотзывы
	$(".review-video-slider").slick({lazyLoad:'ondemand',slidesToShow:3,slidesToScroll:1,dots:false,infinite:true,adaptiveHeight:false,appendArrows:$(".review-video-slider-arrow"),prevArrow:'<button id="prev" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path  d="M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z" /></svg></button>',nextArrow:'<button id="next" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" /></svg></button>',responsive:[{breakpoint:1023,settings:{slidesToShow:2,}},{breakpoint:769,settings:{slidesToShow:1,}},]});

// Видео
	$(".videos-video-slider").slick({lazyLoad:'ondemand',slidesToShow:3,slidesToScroll:1,dots:false,infinite:true,adaptiveHeight:false,appendArrows:$(".videos-video-slider-arrow"),prevArrow:'<button id="prev" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path  d="M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z" /></svg></button>',nextArrow:'<button id="next" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" /></svg></button>',responsive:[{breakpoint:1023,settings:{slidesToShow:2,}},{breakpoint:769,settings:{slidesToShow:1,}},]});
	
// Галерея
	
	
// Галерея Документы 
	$(".gallery .slider-docs").slick({lazyLoad:"ondemand",slidesToShow:5,slidesToScroll:5,dots:!0,infinite:!1,appendArrows:$(".gallery-arrow-docs"),prevArrow:'<button id="prev" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path  d="M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z" /></svg></button>',nextArrow:'<button id="next" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" /></svg></button>',responsive:[{breakpoint:1150,settings:{slidesToShow:4,slidesToScroll:4}},{breakpoint:1023,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:767,settings:{slidesToShow:2}}]});	
...
// Похожие товары
	$('#product-semilar .slider').slick({lazyLoad:"ondemand",slidesToShow:5,slidesToScroll:5,dots:0,infinite:!1,appendArrows:$(".product-semilar-arrow"),prevArrow:'<button id="prev" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path  d="M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z" /></svg></button>',nextArrow:'<button id="next" type="button" class="slick-arrow"><svg viewBox="0 0 24 24"><path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" /></svg></button>',responsive:[{breakpoint:1150,settings:{slidesToShow:4,slidesToScroll:4}},{breakpoint:1023,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:767,settings:{slidesToShow:2}}]});
...
//==============
	[].map.call(document.querySelectorAll('[anim="ripple"]'),function(c){c.addEventListener("mouseover",function(t){t=t.touches?t.touches[0]:t;var e=c.getBoundingClientRect(),o=2*Math.sqrt(Math.pow(e.width,2)+Math.pow(e.height,2));c.style.cssText="--s: 0; --o: 1;",c.offsetTop,c.style.cssText="--t: 1; --o: 0; --d: ".concat(o,"; --x:").concat(t.clientX-e.left,"; --y:").concat(t.clientY-e.top,";")})});
...
document.addEventListener('DOMContentLoaded', function () {
	...
	magic( document.querySelector('h1') )
	...
	function magic(el) {
	  ...
	  tmp.remove()
	  el.innerHTML = lines.map(line => '<span class="an text-fade-in"><span>'+line+'</span></span>').join('')
