...
//	============================================================
	function shortcode_btn ($atts, $content) {
		...
		return '
		<div class="button '.$center.'">
			 <a href="'.$link.'" class="btn" anim="ripple" target="_blank">
				<span>'.$content.'</span>
			</a>
		</div>
		';
...
//	Шорткод квиза
//	============================================================
	function shortcode_marquiz ($atts, $content) {
		extract(shortcode_atts(array(
		"center" => '',
		"marquiz" => '',
		), $atts));
		return '
		<div class="button '.$center.'">
			 <a data-marquiz="'.$marquiz.'" href="#popup:marquiz_'.$marquiz.'" class="btn" anim="ripple">
				<span>'.$content.'</span>
			</a>
		</div>
		';
	}
	add_shortcode('marquiz', 'shortcode_marquiz');	
//	Телефон
//	============================================================
	function city_phone() {
...
function true_add_tinymce_script( $plugin_array ) {
	...
	$plugin_array['text_middle'] = 
	$plugin_array['text_big'] = 
	$plugin_array['text_bigger'] = 
...
function true_register_mce_button( $buttons ) {
	array_push( $buttons, 'text_color', 'text_middle', 'text_big', 'text_bigger', 'city', 'popup_buttons', 'contacts_short', 'price-list' );
	return $buttons;
}