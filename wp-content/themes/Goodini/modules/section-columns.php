...
// Уникальный класс
$stylegroup_class = get_sub_field('style-group')['style-class'];
...
?>
	...
	<section id="<?php echo $building_row; ?>" class="content <?php echo $stylegroup_color.' '.$stylegroup.$styletext.' '.$stylegroup_align.' '.$$stylegroup_class;?>">
