...
?>
	<section id="<?php echo $building_row; ?>" class="lists lists-<?php echo $type; ?> align-<?php echo $align; ?> <?php echo $bg_color; ?> <?php echo $icons_class; ?> <?php echo $text_white ? "text_white" : "" ; ?> <?php echo $design; ?>" <?php echo $bg_image; ?> >
					...
					<div class="list-block">
						<div class="item list-1 <?php echo get_sub_field('list-2') ? "" : "only" ; ?>">
							...
							while( have_rows('list-1') ): the_row(); 
								...
								?>	
								<li>
									<?php if($icons != "none"){ ?><span class="icon"><img src="<?php echo $icons_class == "icon-only" ? $icon_only : get_sub_field('icon') ; ?>" alt="<?php echo strip_tags($text); ?>"></span><?php } ?>
						...
						<?php if(get_sub_field('list-2')){ ?>
						<div class="item list-2">
							<div class="name-list">
								<?php the_sub_field('name-list-2'); ?>
							</div>
							<ul>
							<?php 
