		...
		<div class="container-fluid">
			<div class="row">
				...
				?>
					...
					<a href="<?php the_permalink(); ?>" class="item <?php echo get_field('group')['hero-white_text'] ? "hero-white" : ""; ?>" style="background-image: url(<?php echo get_field('group')['hero-bg']['url']; ?>)">
					<?php }else{ ?>
					<a href="<?php the_permalink(); ?>" class="item <?php echo get_field('group')['hero-white_text'] ? "hero-white" : ""; ?>">				
						<div class="image">
