   		<div class="form form-style-1 hideLabels">
            ...
            <form method="POST" action="<?php echo $formUrl ? $formUrl : get_page_link(get_page_by_title('Страница благодарности'));?>" class="form_block" enctype="multipart/form-data">
				...
				<div class="form-group animate-top">
					<input placeholder="Например, Гульнара" type="text" name="name1" class="form-control "/>
					
				</div>
				<p>Номер телефона</p>
				<div class="form-group animate-top">
					<input placeholder="+7 (999) 999-99-99" type="tel" name="phone" class="form-control required  inp"/>
				...
				<p>Город</p>
                                <div class="form-group animate-top custom-select">
                                    ...
                                    <option value="0">Выберите город из списка</option>
                                        ...
                                        <option value="2">Нижнекамск</option>
