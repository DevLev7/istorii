...
?>
	...
	*/?>
	...
	<?php 
	if( is_tax() ){
	edit_tag_link('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M153.28 448.644L512 89.925 422.075 0 63.356 358.718l-50.86 123.045H.17v29.828L0 512l.64-.266h436.104v-29.97H73.153l80.128-33.12zm268.794-406.26l47.54 47.54-45.983 45.984-47.54-47.54 45.983-45.984zM354.9 109.56l47.54 47.54-22.546 22.546-47.54-47.54L354.9 109.56zm-43.74 43.74l47.54 47.54-205.314 205.312-47.54-47.54L311.16 153.3zM86.364 381.513l44.122 44.122-75.208 31.086 31.086-75.208zm184.544 30.847h160.844v29.97H270.908z"/></svg>', '<button id="edit-button">', '</button>');
	}else{
	edit_post_link('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M153.28 448.644L512 89.925 422.075 0 63.356 358.718l-50.86 123.045H.17v29.828L0 512l.64-.266h436.104v-29.97H73.153l80.128-33.12zm268.794-406.26l47.54 47.54-45.983 45.984-47.54-47.54 45.983-45.984zM354.9 109.56l47.54 47.54-22.546 22.546-47.54-47.54L354.9 109.56zm-43.74 43.74l47.54 47.54-205.314 205.312-47.54-47.54L311.16 153.3zM86.364 381.513l44.122 44.122-75.208 31.086 31.086-75.208zm184.544 30.847h160.844v29.97H270.908z"/></svg>', '<button id="edit-button">', '</button>', get_queried_object_id());
	}	?>
	...
	<script src="<?php echo THEME_JS; ?>/lazyload.min.js"></script>
